...
sequenceDiagram
    ...
    Worker->>Parser: parse(inputStream, fileName)
    Parser-->>Worker: text / markdown (String)
...
| 6 | `MineruDocumentParserAdapter.java:parse()` 或 `ApacheTikaDocumentParserAdapter.java:parse()` | 解析文档 |
